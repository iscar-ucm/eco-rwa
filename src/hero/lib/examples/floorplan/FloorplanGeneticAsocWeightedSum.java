...
public class FloorplanGeneticAsocWeightedSum extends Problem<ComponentVariable> {

  private static final Logger logger = Logger.getLogger(FloorplanGeneticAsocWeightedSum.class.getName());
  ...
  public FloorplanGeneticAsocWeightedSum(FloorplanConfiguration cfg) {
  ...
  @Override
  public FloorplanGeneticAsocWeightedSum clone() {
    FloorplanGeneticAsocWeightedSum clone = new FloorplanGeneticAsocWeightedSum(cfg.clone());
    return clone;
  }
  ...
  public void evaluate(Solution<ComponentVariable> solution) {
    ...
    solution.getObjectives().set(1, wireAndTemp[0] / wireBase + wireAndTemp[1] / tempBase);
  }
  ...
  public static void main(String[] args) {
    if (args.length != 2) {
      System.out.println("Usage: java -jar FloorplanGeneticAsocWeightedSum.jar XmlFilePath TimeInSeconds");
    ...
    try {
      writer = new BufferedWriter(new FileWriter(new File(xmlFilePath.replaceAll(".xml", "WeightedSum.txt"))));
    } catch (IOException ex) {
      Logger.getLogger(FloorplanGeneticAsocWeightedSum.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    FloorplanGeneticAsocWeightedSum problem = new FloorplanGeneticAsocWeightedSum(cfg);
